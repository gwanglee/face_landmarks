...
python train_slim.py --train_dir=$TRAIN_PATH/$TRAIN_NAME/x000_pl2_sgd_0.003_lrd_0.5_64k_bn_l2_0.01 \
...
python train_slim.py --train_dir=$TRAIN_PATH/$TRAIN_NAME/x002_wing_sgd_0.003_lrd_0.5_64k_bn_l2_0.01 \
			--train_tfr=$TFR_PATH/$TRAIN --val_tfr=$TFR_PATH/$VAL \
...
python train_slim.py --train_dir=$TRAIN_PATH/$TRAIN_NAME/x009_ewing_sgd_0.003_lrd_0.5_64k_bn_l2_0.01 \
			--train_tfr=$TFR_PATH/$TRAIN --val_tfr=$TFR_PATH/$VAL \
...
python train_slim.py --train_dir=$TRAIN_PATH/$TRAIN_NAME/x001_l1_sgd_0.003_lrd_0.5_64k_bn_l2_0.01 \
			--train_tfr=$TFR_PATH/$TRAIN --val_tfr=$TFR_PATH/$VAL \
...
python train_slim.py --train_dir=$TRAIN_PATH/$TRAIN_NAME/x003_l2_sgd_0.003_lrd_0.5_64k_bn_l2_0.01 \
			--train_tfr=$TFR_PATH/$TRAIN --val_tfr=$TFR_PATH/$VAL \
...
# 001, 004: loss decay : decay_factor=0.5->0.1, step=64k -> 99k
python train_slim.py --train_dir=$TRAIN_PATH/$TRAIN_NAME/x004_wing_sgd_0.003_lrd_0.1_99k_bn_l2_0.01 \
			--train_tfr=$TFR_PATH/$TRAIN --val_tfr=$TFR_PATH/$VAL \
			--optimizer=sgd --loss=wing --learning_rate_decay_type=exponential --learning_rate=0.003 \
...
# 001, 005, 006, 007: tfrecord [default, centered, extended, centered+extended]
python train_slim.py --train_dir=$TRAIN_PATH/$TRAIN_NAME/x005_l1_sgd_0.003_lrd_0.5_64k_bn_l2_0.01 \
...
python train_slim.py --train_dir=$TRAIN_PATH/$TRAIN_NAME/x006_l1_sgd_0.003_lrd_0.5_64k_bn_l2_0.01 \
			--train_tfr=$TFR_PATH/$TRAIN_E --val_tfr=$TFR_PATH/$VAL_E \
			--optimizer=sgd --loss=l1 --learning_rate_decay_type=exponential --learning_rate=0.003 \
			--learning_rate_decay_factor=0.5 --learning_rate_decay_step=64000 \
			--max_number_of_steps=$MAX_STEP --depth_multiplier=$DEPTH_MULTIPLIER \
			--use_batch_norm=True --regularizer=l2 --regularizer_lambda=0.005 \
...
python train_slim.py --train_dir=$TRAIN_PATH/$TRAIN_NAME/x007_l1_sgd_0.003_lrd_0.5_64k_bn_l2_0.01 \
			--train_tfr=$TFR_PATH/$TRAIN_CE --val_tfr=$TFR_PATH/$VAL_CE \
			--optimizer=sgd --loss=l1 --learning_rate_decay_type=exponential --learning_rate=0.003 \
			--learning_rate_decay_factor=0.5 --learning_rate_decay_step=64000 \
			--max_number_of_steps=$MAX_STEP --depth_multiplier=$DEPTH_MULTIPLIER \
			--use_batch_norm=True --regularizer=l2 --regularizer_lambda=0.005 \
